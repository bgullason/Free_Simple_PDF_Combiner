...
encoded_icon = base64.b64encode(open('icon.png', 'rb').read())
...
# Create the window
window = simple_gui.Window('Free Simple PDF Combiner', col_layout, icon=encoded_icon, titlebar_icon=encoded_icon)
